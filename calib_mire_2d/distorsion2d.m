...
%vars{4}=[ones(rows(u), 1) u v u.*v (u.^2) (v.^2) (u.^2).*v u.*(v.^2) (u.^3) (v.^3) (u.^3.*v) u.^2.*v.^2  (u.*v.^3) (u.^3.*v.^3) u.^4 v.^4 u.^4.*v u.*v.^4];
...
hold on;
h1=plot(allerrU(1,:));	%set(h1,"color",colormap(rand(10,3)));	
h2=plot(allerrU(2,:));	%set(h2,"color",colormap(rand(10,3)));	
h3=plot(allerrU(3,:));	%set(h3,"color",colormap(rand(10,3)));	
